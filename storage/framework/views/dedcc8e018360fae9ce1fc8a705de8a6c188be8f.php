<?php $__env->startPush('styles_top'); ?>
    ...
    <link rel="stylesheet" href="/assets/default/css/quiz_styles.css">
<?php $__env->stopPush(); ?>
    ...
    <div class="container">
                ...
                <div class="row">
                    <div class="col-6 col-md-3 d-flex align-items-center justify-content-center">
                        <div class="d-flex flex-column align-items-center text-center">
                            ...
                            <strong class="font-30 font-weight-bold text-secondary mt-5 passMark"><?php echo e($quiz->pass_mark); ?>/<?php echo e($quizQuestions->sum('grade')); ?></strong>
        ...
        <section class="mt-30 quiz-form">
            <form action="/panel/quizzes/<?php echo e($quiz->id); ?>/store-result" method="post" class="">
                ...
                <input type="hidden" id="quizQuestions" value="<?php echo e(json_encode($quizQuestions)); ?>">
                <input type="hidden" name="total_mark" value="<?php echo e($quizQuestions->sum('grade')); ?>">               
                    <?php $__currentLoopData = $quizQuestions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <fieldset class="question-step question-step-<?php echo e($key + 1); ?>">
                            <div class="rounded-lg shadow-sm py-25 px-20">
                                <div class="quiz-card">
                                <input type="hidden" name="quiz_type" value="<?php echo e($question->type); ?>"> 
                                    ...
                                    <?php endif; ?>
                                    <?php if($question['type'] !== 'dragAndDrop' ): ?>
                                        <div class="">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <ul class="card-list question-list" id="question-list-<?php echo e($key); ?>">
                                                <?php $__currentLoopData = $question->translations->shuffle(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $translation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <input type="hidden" name="question[<?php echo e($question->id); ?>][<?php echo e($translation->id); ?>]" value="<?php echo e($translation->title); ?>">
                                                    <li class="card question-translation" data-id="<?php echo e($translation->id); ?>"><?php echo e($translation->title); ?></li>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </ul>
                                        </div>
                                        <div class="col-md-6">
                                            <ul class="card-list answer-list" id="answer-list-<?php echo e($key); ?>">
                                                <?php $__currentLoopData = $question->quizzesQuestionsAnswers->shuffle(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $answer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li class="card" data-id="<?php echo e($answer->id); ?>"><?php echo e($answer->title); ?></li>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </ul>
                                        </div>
                                    </div>
...
<?php $__env->startPush('scripts_bottom'); ?>
    ...
    <script src="/assets/default/js/parts/quiz_drag_and_drop.js"></script>
<?php $__env->stopPush(); ?>


<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Public\Task\resources\views/web/default/panel/quizzes/start.blade.php ENDPATH**/ ?>