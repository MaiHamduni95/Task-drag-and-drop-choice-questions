...
<?php $__env->startSection('content'); ?>
                        ...
                        <div class="table-responsive">
                            <table class="table custom-table">
                                ...
                                <tr>
                                        ...
                                        <td class="text-left">
                                            <span class="d-block"><?php echo e(optional($result->quiz)->title); ?></span>
                                            <span class="font-12 text-gray d-block"><?php echo e(optional(optional($result->quiz)->webinar)->title); ?></span>
                                        </td>
    ...
    <div class="btn-group dropdown table-actions table-actions-lg table-actions-lg">
        ...
        <div class="dropdown-menu">
            ...
            <?php if($result->status != 'passed' && $result->quiz): ?>
            ...
            <?php if($result->quiz && $result->quiz->webinar): ?>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Public\Task\resources\views/web/default/panel/quizzes/my_results.blade.php ENDPATH**/ ?>