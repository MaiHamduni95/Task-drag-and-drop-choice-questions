                ...
                <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom"
                    ...
                    <div class="absolute-bottom-left index-2">
                        <div class="text-light p-5 pb-2">
                            <div class="mb-2 pb-3">
                                <h1 class="mb-2 display-4 font-weight-bold">Alpha LMS</h1>
                                <h5 class="font-weight-normal text-muted-transparent">fully-featured educational
                                    platform</h5>
                            </div>
                            Developed By <a class="text-light bb" target="_blank" href="https://weapps.solutions">Eng.
                                Mohamed Hekal</a> on <a class="text-light bb" target="_blank"
                                href="weapps.solutions">Alpha</a>
                        </div>
                    </div>
                </div>
...
<?php /**PATH /var/www/fastuser/data/www/lms.weapps.solutions/resources/views/admin/auth/auth_layout.blade.php ENDPATH**/ ?>