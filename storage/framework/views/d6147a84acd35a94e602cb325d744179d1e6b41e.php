            ...
            <div class="d-flex align-items-center justify-content-between mt-15">
                ...
                <div class="custom-control custom-switch">
                    <input type="checkbox" <?php if($sequenceContentHasError): ?> disabled <?php endif; ?>
                        ...
                        <?php if(!empty($item->checkPassedItem())): ?> checked <?php endif; ?>>
...
<?php /**PATH /var/www/fastuser/data/www/lms.weapps.solutions/resources/views/web/default/course/learningPage/components/content_tab/content.blade.php ENDPATH**/ ?>