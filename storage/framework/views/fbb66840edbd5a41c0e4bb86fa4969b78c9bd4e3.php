        ...
        <?php if(!empty($quiz)): ?>
            <section class="mt-30">
                <div class="d-block d-md-flex justify-content-between align-items-center pb-20">
                    ...
                    <div class="d-flex align-items-center mt-18 mt-md-0">
                    <button id="add_drag_and_drop_question" data-quiz-id="<?php echo e($quiz->id); ?>" type="button" class="quiz-form-btn btn btn-primary btn-sm ml-10"><?php echo e(trans('quiz.add_drag_and_drop_choice')); ?></button>
                        ...
                        <?php $__currentLoopData = $quizQuestions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <li data-id="<?php echo e($question->id); ?>" class="quiz-question-card d-flex align-items-center mt-20">
                                <div class="flex-grow-1">
                                    ...
                                    <span>
                                        <?php echo e($question->type === App\Models\QuizzesQuestion::$multiple 
                                            ? trans('quiz.multiple_choice') 
                                            : ($question->type === App\Models\QuizzesQuestion::$descriptive 
                                                ? trans('quiz.descriptive') 
                                                : trans('quiz.dragAndDrop'))); ?> 
                                        | <?php echo e(trans('quiz.grade')); ?>: <?php echo e($question->grade); ?>
...
<?php if(!empty($quiz)): ?>
    ...
    <?php echo $__env->make(getTemplate() .'.panel.quizzes.modals.dragAndDrop_question',['quiz' => $quiz], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?>
<?php /**PATH C:\Users\Public\Task\resources\views/web/default/panel/quizzes/create_quiz_form.blade.php ENDPATH**/ ?>