        ...
        <section class="">
            <?php if(!empty($contactSettings['latitude']) and !empty($contactSettings['longitude'])): ?>
                <div class="contact-map" id="contactMap" data-latitude="<?php echo e($contactSettings['latitude']); ?>"
                    ...
                    data-zoom="<?php echo e($contactSettings['map_zoom'] ?? 12); ?>"></div>
            <?php endif; ?>
...
<?php echo $__env->make(getTemplate() . '.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/fastuser/data/www/lms.weapps.solutions/resources/views/web/default/pages/contact.blade.php ENDPATH**/ ?>