...
<?php $__env->startSection('content'); ?>
    <div class="instructor-finder">
        ...
        <?php if(!empty($mapCenter) and is_array($mapCenter)): ?>
            <section id="instructorFinderMap" class="instructor-finder-map" data-latitude="<?php echo e($mapCenter[0]); ?>"
                data-longitude="<?php echo e($mapCenter[1]); ?>" data-zoom="<?php echo e($mapZoom); ?>">
                ...
                <div class="row flex-lg-row-reverse">
                    <div class="col-12 col-lg-8">
                        ...
                        <div id="instructorsList">
                            <?php if($instructors->isNotEmpty()): ?>
                                <?php $__currentLoopData = $instructors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $instructor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php echo $__env->make('web.default.instructorFinder.components.instructor_card', [
                        ...
                        <div class="text-center">
                            <button type="button" id="loadMoreInstructors" data-url="/instructor-finder"
                                class="btn btn-border-white mt-50 <?php echo e($instructors->lastPage() <= $instructors->currentPage() ? ' d-none' : ''); ?>"><?php echo e(trans('site.load_more_instructors')); ?></button>
                        </div>
                    </div>
...
<?php echo $__env->make('web.default.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/fastuser/data/www/lms.weapps.solutions/resources/views/web/default/instructorFinder/index.blade.php ENDPATH**/ ?>