                        ...
                        <div class="table-responsive">
                            <table class="table custom-table">
                                ...
                                <tr>
                                        ...
                                        <td class="text-left">
                                            <span class="d-block">{{ optional($result->quiz)->title }}</span>
                                            <span class="font-12 text-gray d-block">{{ optional(optional($result->quiz)->webinar)->title }}</span>
                                        </td>
