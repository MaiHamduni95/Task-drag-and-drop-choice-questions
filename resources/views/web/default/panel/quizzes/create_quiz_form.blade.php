        ...
        @if(!empty($quiz))
            <section class="mt-30">
                <div class="d-block d-md-flex justify-content-between align-items-center pb-20">
                    ...
                    <button id="add_drag_and_drop_question" data-quiz-id="{{ $quiz->id }}" type="button" class="quiz-form-btn btn btn-primary btn-sm ml-10">{{ trans('quiz.add_drag_and_drop_choice') }}</button>
                        ...
                        @foreach($quizQuestions as $question)
                            ...
                            <li data-id="{{ $question->id }}" class="quiz-question-card d-flex align-items-center mt-20">
                                <div class="flex-grow-1">
                                    ...
                                    <span>
                                        {{ 
                                            $question->type === App\Models\QuizzesQuestion::$multiple 
...
@if(!empty($quiz))
    ...
    @include(getTemplate() .'.panel.quizzes.modals.dragAndDrop_question',['quiz' => $quiz])
@endif
